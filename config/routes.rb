ProyectoSodmi::Application.routes.draw do
  ...
  resources :sessions_alumno, only: [ :create, :destroy]
 ...
 match '/', to: 'static_pages#home'
  ...
  match '/signup',  to: 'maestros#new'

  #match '/signupalumno',  to: 'alumnos#new'
  match '/signinalumno',  to: 'sessions_alumno#new'
